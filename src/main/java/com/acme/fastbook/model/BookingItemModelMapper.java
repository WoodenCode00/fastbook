...
public interface BookingItemModelMapper {
	...
	/**
	 * Maps from com.acme.fastbook.model.BookingItem
	 * to com.acme.fastbook.persistence.model.BookingItemEntity
	 * 
	...
	/**
	 * Maps from com.acme.fastbook.persistence.model.BookingItemEntity
	 * to com.acme.fastbook.model.BookingItem
	 * 
	...
	/**
	 * Maps from the list of com.acme.fastbook.persistence.model.BookingItemEntity objects
	 * to the list of com.acme.fastbook.model.BookingItem objects
	 * 
	 * @param source list of input com.acme.fastbook.persistence.model.BookingItemEntity objects
	 * 
