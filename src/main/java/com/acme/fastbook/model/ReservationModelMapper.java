...
public abstract class ReservationModelMapper {
  ...
  /**
   * Maps from com.acme.fastbook.model.Reservation to
   * com.acme.fastbook.persistence.model.ReservationEntity
   * 
   * @param source source {@link Reservation} object
   * 
   * @return {@link ReservationEntity} object mapped from {@link Reservation}
   *         source object
   */
  public ReservationEntity mapToDbEntity(Reservation source) {
    ...
    Optional.ofNullable(source.getDateRange()).ifPresent(dateRange -> {
  ...
  /**
   * Partially maps from com.acme.fastbook.model.Reservation to
   * com.acme.fastbook.persistence.model.ReservationEntity
   * 
   * @param source source {@link Reservation} object
   * 
  ...
  /**
   * Maps from com.acme.fastbook.persistence.model.ReservationEntity to
   * com.acme.fastbook.model.Reservation
   * 
   * @param source source {@link ReservationEntity} object
   * 
   * @return {@link Reservation} object mapped from {@link ReservationEntity}
   *         source object
   */
  ...
  /**
   * Partially maps from com.acme.fastbook.persistence.model.ReservationEntity to
   * com.acme.fastbook.model.Reservation
   * 
   * @param source source {@link ReservationEntity} object
   * 
  ...
  /**
   * Maps from the list of com.acme.fastbook.persistence.model.ReservationEntity
   * objects to the list of com.acme.fastbook.model.Reservation objects
   * 
   * @param source list of input
   *               com.acme.fastbook.persistence.model.ReservationEntity objects
   * 
   ...
   */
  public abstract com.acme.fastbook.persistence.model.ReservationStatus mapReservationStatusToDbEntity(
      ReservationStatus source);
   ...
   */
  public abstract ReservationStatus mapDbEntityReservationStatusToReservationStatus(
      com.acme.fastbook.persistence.model.ReservationStatus source);

  /**
   * Maps list of com.acme.fastbook.model.ReservationStatus to the list of
   * com.acme.fastbook.persistence.model.ReservationStatus
   * 
   ...
   */
  public abstract List<com.acme.fastbook.persistence.model.ReservationStatus> mapListOfStatusesToDbEntityStatuses(
      List<ReservationStatus> source);

  /**
   * Presents java.util.UUID as
   * com.acme.fastbook.persistence.model.BookingItemEntity. This method is used
   * for conversions in entity class for the field representing foreign key
   * definition (annotated by ManyToOne).
   * 
  ...
  /**
   * Presents com.acme.fastbook.persistence.model.BookingItemEntity as
   * java.util.UUID object. This method is used for conversions in entity class
   * for the field representing foreign key definition (annotated by ManyToOne).
   * 
